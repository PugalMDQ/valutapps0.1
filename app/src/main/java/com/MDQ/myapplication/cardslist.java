...
public class cardslist extends AppCompatActivity  implements AccountListResponseInterface {
    ...
    public void generateAccountListProcessed(GenerateAccountListResponseModel generateAccountListResponseModel ) {
        ...
        afct=new adapterforcardlist(generateAccountListResponseModel,getApplicationContext());

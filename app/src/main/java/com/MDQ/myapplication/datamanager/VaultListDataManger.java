...
public class VaultListDataManger {
    ...
    public void callEnqueue(String url, String token, final ResponseHandler<GenerateVaultListResponseModel> dataresponse) {
        ...
        userAccountListCall.enqueue(new Callback<GenerateVaultListResponseModel>() {
             ...
             */
            @Override
            public void onResponse(Call<GenerateVaultListResponseModel> call, Response<GenerateVaultListResponseModel> response) {
                /**
             ...
             */
            @Override
            public void onFailure(Call<GenerateVaultListResponseModel> call, Throwable t) {
